                    ...
                    <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                     ...
                     <!-- Menu -->
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('menu_id') is-invalid @enderror" name="menu_id" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('sub_title') is-invalid @enderror" type="text" name="sub_title" placeholder="Enter sub title" value="{{ old('sub_title') }}">
                            @error('sub_title')
                                <span class="invalid-feedback d-block"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
